...
def load_dataset(store_id):
    ...
    df10 = pd.read_csv('/home/bruna/Documentos/DataScience_em_Producao/data/test.csv')
    df_store_raw = pd.read_csv('/home/bruna/Documentos/DataScience_em_Producao/data/store.csv')
